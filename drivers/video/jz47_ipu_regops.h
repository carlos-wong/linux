...
#define IPU_INFMT_PACKED (1 << 10)
#define IPU_LCDCSEL     (1 << 11)
#define IPU_SRC_PAGEMAP (1 << 12)
#define IPU_DEST_PAGEMAP  (1 << 13)
#define IPU_DISPSEL       (1 << 14)
#define IPU_FILED_CONF_EN (1 << 15)
#define IPU_FILED_SELBOTT (1 << 16)
#define IPU_DFIXSEL     (1 << 17)
#define IPU_ZOOMSEL     (1 << 18)
#define IPU_ADDRSEL     (1 << 20)
#define IPU_CONF_MODE   (1 << 21)
#define IPU_ENHANCE     (1 << 23)
#define IPU_DMA_OPT     (1 << 24)
...
#define IM_FMT_PACKED_RGB888 (0x02 << 0) //IPU_CONTROL.SPKG_SEL MUST 1
#define IM_FMT_PACKED_RGB565 (0x03 << 0) //IPU_CONTROL.SPKG_SEL MUST 1
...
#define get_ipu_ctrl(IPU_V_BASE) \
...
#define enable_ipu_infmt_packed(IPU_V_BASE)  \
(REG32(IPU_V_BASE + REG_CTRL) |= IPU_INFMT_PACKED)

#define disable_ipu_infmt_packed(IPU_V_BASE)  \
(REG32(IPU_V_BASE + REG_CTRL) &= ~IPU_INFMT_PACKED)
...
do {                                                               \
    REG32(IPU_V_BASE + REG_CTRL) = (REG32(IPU_V_BASE + REG_CTRL) & ~IPU_FILED_SELBOTT);              \
...
do {                                        \
  ...
  /*REG32(IPU_V_BASE + REG_CTRL) = IPU_RESET; */ \
    REG32(IPU_V_BASE + REG_CTRL) = IPU_EN;     \
    REG32(IPU_V_BASE + REG_CTRL) |= IPU_FILED_SELBOTT;     \
} while (0)
#else
#define reset_ipu(IPU_V_BASE) \
do {                                        \
...
#define get_ipu_status(IPU_V_BASE) \
